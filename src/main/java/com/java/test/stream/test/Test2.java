...
import com.java.test.enums.CaloricLevel;
import com.java.test.enums.Type;
import com.java.test.stream.bean.Dish;
import com.java.test.stream.bean.Trader;
import com.java.test.stream.bean.Transaction;
